import type { AssistantOptionResponse } from "../../../api";
import RecommendationConstraints from "../preferences/RecommendationConstraints";
import ScrollFadeFrame from "./ScrollFadeFrame";
import type { AssistantWorkflow } from "./useAssistantWorkflow";

type AssistantPromptWorkspaceProps = {
...
function AssistantPromptWorkspace({
   workflow,
   onUseGuided,
}: AssistantPromptWorkspaceProps) {
   const {
      canSubmit,
      changeConstraints,
      changePrompt,
         ...
         <div className="assistant-step" data-step="1">
            <header className="assistant-step__heading">
               ...
               <div>
                  ...
                  <p>
                     Counts include only owned games with ready IGDB metadata.
                  </p>
               </div>
            </header>
               ...
               <header className="assistant-step__heading">
                  ...
                  <div>
                     ...
                     <p>
                        ...
                        games or fewer to stay within Gemini’s limitations. Once
                        that threshold is reached, additional filters are
                        optional.
                     </p>
                  </div>
               </header>
            ...
            <div className="assistant-step" data-step="3">
               ...
               {response?.status === "needs_refinement" && (
                  ...
                  >
                     ...
                     <p>
                        The complete pool is over the {response.candidate_limit}
                        -game assistant limit. Add a factual filter above, then
                        ask again. No Gemini call was made.
                     </p>
                  </div>
               )}
               ...
               <div className="assistant-submit-row">
                  ...
                  <p>
                     Processing a large number of games may take several seconds
                     due to Gemini’s free-tier limitations.
                  </p>
               </div>
            </div>
         )}
...
export default AssistantPromptWorkspace;
