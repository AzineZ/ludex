...
import ReferenceKeywordAutocomplete from "../../features/recommendations/references/ReferenceKeywordAutocomplete";
import {
   useReferenceKeywordBrowse,
   type ReferenceKeywordBrowseResult,
} from "../../features/recommendations/references/useReferenceKeywordBrowse";

vi.mock(
   "../../features/recommendations/references/useReferenceKeywordBrowse",
   async (importOriginal) => {
      const actual = await importOriginal<
         typeof import("../../features/recommendations/references/useReferenceKeywordBrowse")
      >();
