...
} from "../../features/recommendations/preferences/usePreferenceValidation";

vi.mock(
   "../../features/recommendations/preferences/usePreferenceValidation",
   async (importOriginal) => {
      const actual = await importOriginal<
         typeof import("../../features/recommendations/preferences/usePreferenceValidation")
      >();
