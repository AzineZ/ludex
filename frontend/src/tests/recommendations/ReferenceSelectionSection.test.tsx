...
import ReferenceSelectionSection from "../../features/recommendations/references/ReferenceSelectionSection";
import {
   useReferenceSelection,
   type ReferenceSelectionResult,
   type SelectedReference,
} from "../../features/recommendations/references/useReferenceSelection";
...
vi.mock(
   "../../features/recommendations/references/useReferenceSelection",
   async (importOriginal) => {
      const actual = await importOriginal<
         typeof import("../../features/recommendations/references/useReferenceSelection")
      >();
...
vi.mock(
   "../../features/recommendations/references/ReferenceGameAutocomplete",
   () => ({
      default: ({
         sessionEpoch,
         selectedSteamAppIds,
