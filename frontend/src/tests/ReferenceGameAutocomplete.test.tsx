...
import ReferenceGameAutocomplete from "../features/recommendations/ReferenceGameAutocomplete";
import {
   useReferenceGameSearch,
   type ReferenceGameSearchResult,
} from "../features/recommendations/useReferenceGameSearch";


vi.mock(
   "../features/recommendations/useReferenceGameSearch",
